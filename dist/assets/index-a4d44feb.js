...
reactIs_production_min.isValidElementType = function(a) {
  return "string" === typeof a || "function" === typeof a || a === e || a === m$1 || a === g || a === f || a === p$1 || a === q || "object" === typeof a && null !== a && (a.$$typeof === t$1 || a.$$typeof === r$1 || a.$$typeof === h || a.$$typeof === k || a.$$typeof === n || a.$$typeof === w || a.$$typeof === x || a.$$typeof === y || a.$$typeof === v$1);
};
...
function getTheme2(manager2, fallback) {
...
function parseGradient(value, theme2) {
  ...
  const { type, values } = (_b3 = (_a4 = regex.exec(value)) == null ? void 0 : _a4.groups) != null ? _b3 : {};
  if (!type || !values)
    return value;
...
function flattenTokens({
  ...
  var _a4, _b3;
  const tokenEntries = Object.entries((_a4 = flatten(tokens2)) != null ? _a4 : {}).map(
    ([token2, value]) => {
  ...
  const semanticTokenEntries = Object.entries(
    (_b3 = flatten(semanticTokens2, 1)) != null ? _b3 : {}
  ).map(([token2, value]) => {
...
var baseStyleTrack$2 = defineStyle((props) => {
  ...
  return {
    ...
    _checked: {
      [$bg$e.variable]: `colors.${c2}.500`,
      _dark: {
        [$bg$e.variable]: `colors.${c2}.200`
      }
    },
    bg: $bg$e.reference
  };
...
var $border$2 = cssVar$1("tabs-border-color");
...
var variantLine = definePartsStyle$m((props) => {
  ...
  return {
    ...
    tab: {
      ...
      [marginProp]: "-2px",
      _selected: {
        [$fg$6.variable]: `colors.${c2}.600`,
        _dark: {
          [$fg$6.variable]: `colors.${c2}.300`
        },
  ...
  return {
    tab: {
      ...
      _selected: {
        ...
        _dark: {
          [$fg$6.variable]: `colors.${c2}.300`,
          [$border$2.variable]: `colors.gray.800`
        },
        borderColor: "inherit",
  ...
  return {
    tab: {
      ...
      _selected: {
        ...
        [$bg$d.variable]: `colors.${c2}.600`,
        _dark: {
          [$fg$6.variable]: "colors.gray.800",
          [$bg$d.variable]: `colors.${c2}.300`
        }
      },
      color: $fg$6.reference,
      bg: $bg$d.reference
...
var variantSubtle$1 = defineStyle((props) => {
  ...
  return {
    [$bg$c.variable]: `colors.${c2}.100`,
    [$fg$5.variable]: `colors.${c2}.800`,
    _dark: {
...
var baseStyleFilledTrack = defineStyle((props) => {
  ...
  return {
    width: "inherit",
    height: "inherit",
    [$bg$8.variable]: `colors.${c2}.500`,
    _dark: {
      [$bg$8.variable]: `colors.${c2}.200`
    },
    bg: $bg$8.reference
  };
});
...
var $shadow = cssVar$1("menu-shadow");
...
function useStyleConfigImpl(themeKey, props = {}) {
  ...
  if (styleConfig) {
    ...
    const isStyleEqual = reactFastCompare(stylesRef.current, styles2);
    if (!isStyleEqual) {
...
var EnvironmentContext = reactExports.createContext(defaultEnv);
...
var ChakraProvider$1 = (props) => {
  ...
  const _children = /* @__PURE__ */ jsx(EnvironmentProvider, { environment, children });
  return /* @__PURE__ */ jsx(ThemeProvider2, { theme: theme2, cssVarsRoot, children: /* @__PURE__ */ jsxs(
    ColorModeProvider,
    {
      colorModeManager,
...
function createMotionComponent({ preloadedFeatures, createVisualElement, projectionNodeConstructor, useRender, useVisualState, Component }) {
  ...
  function MotionComponent(props, externalRef) {
    ...
    return reactExports.createElement(
      ...
      features,
      reactExports.createElement(MotionContext.Provider, { value: context }, useRender(Component, props, projectionId, useMotionRef(visualState, context.visualElement, externalRef), visualState, isStatic, context.visualElement))
    );
  }
...
const sortTransformProps = (a, b2) => transformPropOrder.indexOf(a) - transformPropOrder.indexOf(b2);
...
function buildHTMLStyles(state2, latestValues, options, transformTemplate2) {
  const { style: style2, vars, transform: transform2, transformKeys: transformKeys2, transformOrigin } = state2;
...
function useViewport({ visualElement, whileInView, onViewportEnter, onViewportLeave, viewport = {} }) {
  const state2 = reactExports.useRef({
...
function getAnimatableNone(key, value) {
  ...
  return (_a4 = defaultValueType.getAnimatableNone) === null || _a4 === void 0 ? void 0 : _a4.call(defaultValueType, value);
}
...
function getOrigin(target, transition2, visualElement) {
  ...
  for (const key in target) {
    ...
    origin[key] = transitionOrigin !== void 0 ? transitionOrigin : (_a4 = visualElement.getValue(key)) === null || _a4 === void 0 ? void 0 : _a4.get();
  }
  return origin;
}
...
const appearStoreId = (id2, value) => `${id2}: ${value}`;
function handoffOptimizedAppearAnimation(id2, name) {
  const { MotionAppearAnimations } = window;
  const animationId = appearStoreId(id2, transformProps.has(name) ? "transform" : name);
...
spring.needsInterpolation = (a, b2) => typeof a === "string" || typeof b2 === "string";
const zero = (_t) => 0;
function decay({
...
function animate$1({ duration, driver = framesync, elapsed = 0, repeat: repeatMax = 0, repeatType = "loop", repeatDelay = 0, keyframes: keyframes$12, autoplay = true, onPlay, onStop, onComplete, onRepeat, onUpdate, type = "keyframes", ...options }) {
  var _a4, _b3;
  let driverControls;
  let repeatCount = 0;
  ...
  const animator = types[keyframes$12.length > 2 ? "keyframes" : type] || keyframes2;
  const origin = keyframes$12[0];
  const target = keyframes$12[keyframes$12.length - 1];
  if ((_b3 = (_a4 = animator).needsInterpolation) === null || _b3 === void 0 ? void 0 : _b3.call(_a4, origin, target)) {
  ...
  return {
    ...
    sample: (t2) => {
      return animation.next(Math.max(0, t2));
    }
  };
}
...
function inertia({ keyframes: keyframes3, velocity = 0, min, max, power = 0.8, timeConstant = 750, bounceStiffness = 500, bounceDamping = 10, restDelta = 1, modifyTarget, driver, onUpdate, onComplete, onStop }) {
  const origin = keyframes3[0];
  ...
  function startAnimation(options) {
    ...
    currentAnimation = animate$1({
      ...
      onUpdate: (v2) => {
        ...
        (_a4 = options.onUpdate) === null || _a4 === void 0 ? void 0 : _a4.call(options, v2);
      },
      onComplete,
      onStop
    });
...
function animateVariant(visualElement, variant, options = {}) {
  ...
  const getChildAnimations = ((_a4 = visualElement.variantChildren) === null || _a4 === void 0 ? void 0 : _a4.size) ? (forwardDelay = 0) => {
...
function animateTarget(visualElement, definition, { delay: delay2 = 0, transitionOverride, type } = {}) {
  ...
  const animations2 = [];
  const animationTypeState = type && ((_a4 = visualElement.animationState) === null || _a4 === void 0 ? void 0 : _a4.getState()[type]);
  for (const key in target) {
...
function applyTreeDeltas(box, treeScale, treePath, isSharedTransition = false) {
  ...
  for (let i = 0; i < treeLength; i++) {
    ...
    if (((_b3 = (_a4 = node2.instance) === null || _a4 === void 0 ? void 0 : _a4.style) === null || _b3 === void 0 ? void 0 : _b3.display) === "contents")
      continue;
...
class VisualElementDragControls {
    ...
    const onStart = (event, info) => {
      ...
      eachAxis((axis) => {
        ...
        if (percent.test(current)) {
          const measuredAxis = (_b3 = (_a5 = this.visualElement.projection) === null || _a5 === void 0 ? void 0 : _a5.layout) === null || _b3 === void 0 ? void 0 : _b3.layoutBox[axis];
          if (measuredAxis) {
      ...
      (_a4 = this.visualElement.animationState) === null || _a4 === void 0 ? void 0 : _a4.setActive(AnimationType.Drag, true);
    };
  ...
  cancel() {
    ...
    (_a4 = this.panSession) === null || _a4 === void 0 ? void 0 : _a4.end();
  ...
  getAxisMotionValue(axis) {
    ...
    return externalMotionValue ? externalMotionValue : this.visualElement.getValue(axis, ((_a4 = this.visualElement.getProps().initial) === null || _a4 === void 0 ? void 0 : _a4[axis]) || 0);
  }
  snapToCursor(point) {
    eachAxis((axis) => {
      const { drag: drag2 } = this.getProps();
  ...
  scalePositionWithinConstraints() {
    ...
    (_a4 = projection.root) === null || _a4 === void 0 ? void 0 : _a4.updateScroll();
...
class VisualElement {
  ...
  mount(instance) {
    ...
    if (this.parent && this.isVariantNode && !this.isControllingVariants) {
      this.removeFromVariantTree = (_a4 = this.parent) === null || _a4 === void 0 ? void 0 : _a4.addVariantChild(this);
    }
  ...
  unmount() {
    var _a4, _b3, _c2;
    (_a4 = this.projection) === null || _a4 === void 0 ? void 0 : _a4.unmount();
  ...
  loadFeatures(renderedProps, isStrict, preloadedFeatures, projectionId, ProjectionNodeConstructor, initialLayoutGroupConfig) {
    ...
    for (let i = 0; i < numFeatures; i++) {
      ...
      if (isEnabled(renderedProps) && Component) {
        features.push(reactExports.createElement(Component, {
          key: name,
          ...renderedProps,
          visualElement: this
        }));
  ...
  getVariant(name) {
    var _a4;
    return (_a4 = this.props.variants) === null || _a4 === void 0 ? void 0 : _a4[name];
  }
  ...
  getClosestVariantNode() {
    var _a4;
    return this.isVariantNode ? this : (_a4 = this.parent) === null || _a4 === void 0 ? void 0 : _a4.getClosestVariantNode();
  }
  getVariantContext(startAtParent = false) {
    var _a4, _b3;
    if (startAtParent)
      return (_a4 = this.parent) === null || _a4 === void 0 ? void 0 : _a4.getVariantContext();
  ...
  removeValue(key) {
    ...
    (_a4 = this.valueSubscriptions.get(key)) === null || _a4 === void 0 ? void 0 : _a4();
  ...
  notify(eventName, ...args) {
    var _a4;
    (_a4 = this.events[eventName]) === null || _a4 === void 0 ? void 0 : _a4.notify(...args);
  }
}
...
class DOMVisualElement extends VisualElement {
  ...
  getBaseTargetFromProps(props, key) {
    var _a4;
    return (_a4 = props.style) === null || _a4 === void 0 ? void 0 : _a4[key];
  }
...
class SVGVisualElement extends DOMVisualElement {
  ...
  readValueFromInstance(instance, key) {
    var _a4;
    if (transformProps.has(key)) {
      return ((_a4 = getDefaultValueType(key)) === null || _a4 === void 0 ? void 0 : _a4.default) || 0;
    }
  ...
  getSnapshotBeforeUpdate(prevProps) {
    ...
    if (prevProps.isPresent !== isPresent2) {
      if (isPresent2) {
        ...
        sync.postRender(() => {
          var _a4;
          if (!((_a4 = projection.getStack()) === null || _a4 === void 0 ? void 0 : _a4.members.length)) {
            this.safeToRemove();
          }
        });
      }
...
class NodeStack {
  ...
  promote(node2, preserveFollowOpacity) {
    ...
    if (prevLead) {
      ...
      if ((_a4 = node2.root) === null || _a4 === void 0 ? void 0 : _a4.isUpdating) {
  ...
  exitAnimationComplete() {
    this.members.forEach((node2) => {
      ...
      (_b3 = (_a4 = node2.options).onExitComplete) === null || _b3 === void 0 ? void 0 : _b3.call(_a4);
      (_e2 = (_c2 = node2.resumingFrom) === null || _c2 === void 0 ? void 0 : (_d2 = _c2.options).onExitComplete) === null || _e2 === void 0 ? void 0 : _e2.call(_d2);
    });
  }
  scheduleRender() {
    this.members.forEach((node2) => {
...
function createProjectionNode({ attachResizeListener, defaultParent, measureScroll, checkIsScrollRoot, resetTransform }) {
  return class ProjectionNode {
    ...
    mount(instance, isLayoutDirty = false) {
      ...
      (_a4 = this.parent) === null || _a4 === void 0 ? void 0 : _a4.children.add(this);
      ...
      if (this.options.animate !== false && visualElement && (layoutId || layout2)) {
        this.addEventListener("didUpdate", ({ delta, hasLayoutChanged, hasRelativeTargetChanged, layout: newLayout }) => {
          ...
          const layoutTransition = (_b3 = (_a5 = this.options.transition) !== null && _a5 !== void 0 ? _a5 : visualElement.getDefaultTransition()) !== null && _b3 !== void 0 ? _b3 : defaultLayoutTransition;
    ...
    unmount() {
      ...
      (_a4 = this.getStack()) === null || _a4 === void 0 ? void 0 : _a4.remove(this);
    ...
    isTreeAnimationBlocked() {
      var _a4;
      return this.isAnimationBlocked || ((_a4 = this.parent) === null || _a4 === void 0 ? void 0 : _a4.isTreeAnimationBlocked()) || false;
    }
    startUpdate() {
      var _a4;
      ...
      (_a4 = this.nodes) === null || _a4 === void 0 ? void 0 : _a4.forEach(resetRotation);
      this.animationId++;
    }
    willUpdate(shouldNotifyListeners = true) {
      var _a4, _b3, _c2;
      if (this.root.isUpdateBlocked()) {
        (_b3 = (_a4 = this.options).onExitComplete) === null || _b3 === void 0 ? void 0 : _b3.call(_a4);
        return;
      }
      ...
      if (layoutId === void 0 && !layout2)
        return;
      const transformTemplate2 = (_c2 = this.options.visualElement) === null || _c2 === void 0 ? void 0 : _c2.getProps().transformTemplate;
    ...
    updateLayout() {
      ...
      (_a4 = this.options.visualElement) === null || _a4 === void 0 ? void 0 : _a4.notify("LayoutMeasure", this.layout.layoutBox, prevLayout === null || prevLayout === void 0 ? void 0 : prevLayout.layoutBox);
    }
    ...
    resetTransform() {
      ...
      const transformTemplate2 = (_a4 = this.options.visualElement) === null || _a4 === void 0 ? void 0 : _a4.getProps().transformTemplate;
    ...
    removeTransform(box) {
      ...
      for (let i = 0; i < this.path.length; i++) {
        ...
        removeBoxTransforms(boxWithoutTransform, node2.latestValues, (_a4 = node2.snapshot) === null || _a4 === void 0 ? void 0 : _a4.layoutBox, sourceBox);
      }
      if (hasTransform(this.latestValues)) {
    ...
    resolveTargetDelta() {
      ...
      if (this.relativeTarget && this.relativeTargetOrigin && ((_a4 = this.relativeParent) === null || _a4 === void 0 ? void 0 : _a4.target)) {
    ...
    calcProjection() {
      ...
      if (canSkip)
        return;
      const { layout: layout2, layoutId } = this.options;
      this.isTreeAnimating = Boolean(((_a4 = this.parent) === null || _a4 === void 0 ? void 0 : _a4.isTreeAnimating) || this.currentAnimation || this.pendingAnimation);
    ...
    scheduleRender(notifyAll = true) {
      var _a4, _b3, _c2;
      (_b3 = (_a4 = this.options).scheduleRender) === null || _b3 === void 0 ? void 0 : _b3.call(_a4);
    ...
    setAnimationOrigin(delta, hasOnlyRelativeTargetChanged = false) {
      ...
      const isSharedLayoutAnimation = (snapshot === null || snapshot === void 0 ? void 0 : snapshot.source) !== ((_a4 = this.layout) === null || _a4 === void 0 ? void 0 : _a4.source);
      const isOnlyMember = (((_b3 = this.getStack()) === null || _b3 === void 0 ? void 0 : _b3.members.length) || 0) <= 1;
      ...
      this.mixTargetDelta = (latest) => {
        ...
        if (this.relativeTarget && this.relativeTargetOrigin && this.layout && ((_a5 = this.relativeParent) === null || _a5 === void 0 ? void 0 : _a5.layout)) {
    ...
    startAnimation(options) {
      ...
      (_a4 = this.currentAnimation) === null || _a4 === void 0 ? void 0 : _a4.stop();
      ...
      this.pendingAnimation = sync.update(() => {
        ...
        this.currentAnimation = animate(0, animationTarget, {
          ...
          onUpdate: (latest) => {
            var _a5;
            this.mixTargetDelta(latest);
            (_a5 = options.onUpdate) === null || _a5 === void 0 ? void 0 : _a5.call(options, latest);
          },
          onComplete: () => {
            var _a5;
            (_a5 = options.onComplete) === null || _a5 === void 0 ? void 0 : _a5.call(options);
    ...
    completeAnimation() {
      ...
      (_a4 = this.getStack()) === null || _a4 === void 0 ? void 0 : _a4.exitAnimationComplete();
    ...
    finishAnimation() {
      ...
      if (this.currentAnimation) {
        (_a4 = this.mixTargetDelta) === null || _a4 === void 0 ? void 0 : _a4.call(this, animationTarget);
    ...
    registerSharedNode(layoutId, node2) {
      ...
      stack.add(node2);
      node2.promote({
        transition: (_a4 = node2.options.initialPromotionConfig) === null || _a4 === void 0 ? void 0 : _a4.transition,
        preserveFollowOpacity: (_c2 = (_b3 = node2.options.initialPromotionConfig) === null || _b3 === void 0 ? void 0 : _b3.shouldPreserveFollowOpacity) === null || _c2 === void 0 ? void 0 : _c2.call(_b3, node2)
      });
    }
    isLead() {
    ...
    getProjectionStyles(styleProp = {}) {
      ...
      if (lead.animationValues) {
        styles2.opacity = lead === this ? (_c2 = (_b3 = valuesToRender.opacity) !== null && _b3 !== void 0 ? _b3 : this.latestValues.opacity) !== null && _c2 !== void 0 ? _c2 : 1 : this.preserveOpacity ? this.latestValues.opacity : valuesToRender.opacityExit;
      } else {
...
function notifyLayoutUpdate(node2) {
  ...
  if (node2.isLead() && node2.layout && snapshot && node2.hasListeners("didUpdate")) {
    ...
    (_c2 = (_b3 = node2.options).onExitComplete) === null || _c2 === void 0 ? void 0 : _c2.call(_b3);
  }
...
var ToastProvider = (props) => {
  ...
  return /* @__PURE__ */ jsxs(Fragment, { children: [
    children,
    /* @__PURE__ */ jsx(Portal, { ...portalProps, children: toastList })
  ] });
};
...
function ButtonContent(props) {
  ...
  return /* @__PURE__ */ jsxs(Fragment, { children: [
    leftIcon && /* @__PURE__ */ jsx(ButtonIcon, { marginEnd: iconSpacing2, children: leftIcon }),
    children,
    rightIcon && /* @__PURE__ */ jsx(ButtonIcon, { marginStart: iconSpacing2, children: rightIcon })
  ] });
}
...
function useFormControlProvider(props) {
  ...
  const [isFocused, setFocus2] = reactExports.useState(false);
  ...
  const getLabelProps = reactExports.useCallback(
    (props2 = {}, forwardedRef = null) => {
      ...
      return {
        ...
        id: (_a4 = props2.id) != null ? _a4 : labelId,
        htmlFor: (_b3 = props2.htmlFor) != null ? _b3 : id2
      };
    },
...
var FormControl = forwardRef(
  function FormControl2(props, ref) {
    ...
    return /* @__PURE__ */ jsx(FormControlProvider, { value: context, children: /* @__PURE__ */ jsx(FormControlStylesProvider, { value: styles2, children: /* @__PURE__ */ jsx(
      chakra.div,
      {
        ...getRootProps({}, ref),
        className,
...
function useDisclosure(props = {}) {
  ...
  const onOpenPropCallbackRef = useCallbackRef$1(onOpenProp);
  const onClosePropCallbackRef = useCallbackRef$1(onCloseProp);
...
function isHTMLElement(el2) {
  ...
  if (!isElement(el2))
    return false;
  const win2 = (_a4 = el2.ownerDocument.defaultView) != null ? _a4 : window;
...
var getFocusablesWithShadowDom = function(parent, withGuards) {
  var _a4;
  return toArray(((_a4 = parent.shadowRoot) === null || _a4 === void 0 ? void 0 : _a4.children) || parent.children).reduce(function(acc, child) {
...
var FocusLock = (props) => {
  ...
  const onActivation = reactExports.useCallback(() => {
    if (initialFocusRef == null ? void 0 : initialFocusRef.current) {
      ...
      if (focusables.length === 0) {
        requestAnimationFrame(() => {
          var _a4;
          (_a4 = contentRef.current) == null ? void 0 : _a4.focus();
        });
      }
    }
  ...
  const onDeactivation = reactExports.useCallback(() => {
    var _a4;
    (_a4 = finalFocusRef == null ? void 0 : finalFocusRef.current) == null ? void 0 : _a4.focus();
  }, [finalFocusRef]);
...
var RemoveScroll$1 = reactExports.forwardRef(function(props, parentRef) {
  ...
  return reactExports.createElement(
    ...
    forwardProps ? reactExports.cloneElement(reactExports.Children.only(children), __assign$1(__assign$1({}, containerProps), { ref: containerRef })) : reactExports.createElement(Container2, __assign$1({}, containerProps, { className, ref: containerRef }), children)
  );
});
...
const NavItem = (props) => /* @__PURE__ */ jsx(
  Link,
  {
    px: 2,
    py: 1,
...
function NavBar() {
  ...
  return /* @__PURE__ */ jsx(Fragment, { children: /* @__PURE__ */ jsxs(
    Box,
    {
      ...
      zIndex: 100,
      children: [
        /* @__PURE__ */ jsxs(Flex, { h: 16, alignItems: "center", justifyContent: "space-between", children: [
          /* @__PURE__ */ jsxs(Flex, { children: [
            /* @__PURE__ */ jsx(FaCode, { color: "pinkish" }),
            /* @__PURE__ */ jsx(Text, { as: "b", fontSize: "2xl", ml: "2", children: "Portfolio" })
          ] }),
          /* @__PURE__ */ jsx(
            IconButton,
            {
              ...
              icon: isOpen ? /* @__PURE__ */ jsx(CloseIcon, { colorInterpolation: "pink", color: "black" }) : /* @__PURE__ */ jsx(HamburgerIcon, { outlineColor: "pink", color: "black" }),
              "aria-label": "Open Menu",
              display: { md: "none" },
              onClick: isOpen ? onClose : onOpen
            }
          ),
          /* @__PURE__ */ jsxs(HStack, { as: "nav", spacing: 4, display: { base: "none", md: "flex" }, children: [
            /* @__PURE__ */ jsx(NavItem, { text: "Home" }),
            /* @__PURE__ */ jsx(NavItem, { text: "Projects" }),
            /* @__PURE__ */ jsx(NavItem, { text: "Skills" }),
            /* @__PURE__ */ jsx(NavItem, { text: "Hire me" })
          ] })
        ] }),
        isOpen ? /* @__PURE__ */ jsx(Box, { pb: 4, display: { md: "none" }, children: /* @__PURE__ */ jsxs(Stack, { as: "nav", spacing: 4, children: [
          /* @__PURE__ */ jsx(NavItem, { text: "Home" }),
          /* @__PURE__ */ jsx(NavItem, { text: "Projects" }),
          /* @__PURE__ */ jsx(NavItem, { text: "Skills" }),
          /* @__PURE__ */ jsx(NavItem, { text: "Hire me" })
...
function MotionItem({ children }) {
  return /* @__PURE__ */ jsx(motion.div, { variants: itemAnimation, children });
}
const Upwork = "/Yomna-s-Portfolio/assets/upwork-05f0dc5e.svg";
function Summary() {
  const CustomButton = (props) => /* @__PURE__ */ jsx(
    Button,
    {
      p: "0",
      backgroundColor: "transparent",
      ...
      children: /* @__PURE__ */ jsx(Link, { href: props.link, isExternal: true, children: props.icon })
    }
  );
  return /* @__PURE__ */ jsxs(Box, { m: "auto", p: "20", pt: "40", id: "home", children: [
    /* @__PURE__ */ jsx(MotionItem, { children: /* @__PURE__ */ jsx(Text, { display: "block", as: "b", fontSize: "3xl", children: "Hello, I'm Yomna" }) }),
    /* @__PURE__ */ jsx(MotionItem, { children: /* @__PURE__ */ jsx(Text, { as: "b", fontSize: "3xl", children: "A Mobile Apps Developer & Web Developer." }) }),
    /* @__PURE__ */ jsx(MotionItem, { children: /* @__PURE__ */ jsxs(Flex, { alignItems: "center", my: "4", mb: "8", children: [
      /* @__PURE__ */ jsx(
        Link,
        {
          ...
          children: /* @__PURE__ */ jsx(
            Button,
            {
              ...
              children: /* @__PURE__ */ jsx(FaArrowUp, { size: "14px" })
            }
          )
        }
      ),
      /* @__PURE__ */ jsx(Text, { pl: "4", fontSize: "xl", children: "Let's talk" })
    ] }) }),
    /* @__PURE__ */ jsx(MotionItem, { children: /* @__PURE__ */ jsx(Divider, { orientation: "horizontal", width: "50%" }) }),
    /* @__PURE__ */ jsx(MotionItem, { children: /* @__PURE__ */ jsx(Flex, { my: "4", children: /* @__PURE__ */ jsxs(ButtonGroup, { gap: "2", children: [
      /* @__PURE__ */ jsx(
        CustomButton,
        {
          icon: /* @__PURE__ */ jsx(FaLinkedin, { size: "30", color: "#0078B2" }),
      ...
      /* @__PURE__ */ jsx(
        CustomButton,
        {
          icon: /* @__PURE__ */ jsx(FaGithub, { size: "30" }),
      ...
      /* @__PURE__ */ jsx(
        CustomButton,
        {
          icon: /* @__PURE__ */ jsx(Image$1, { src: Upwork, width: "20", height: "20" }),
...
const whosapp = "/Yomna-s-Portfolio/assets/whosapp-f468aac6.png";
const nannyFinder = "data:image/png;base64,";
const ghanaFootball = "/Yomna-s-Portfolio/assets/ghanaFootball-8695f603.png";
const frontendDevelopment = "/Yomna-s-Portfolio/assets/fontendDevelopment-f25ffb4d.jpeg";
const todo = "/Yomna-s-Portfolio/assets/todo-6e6c1bbd.jpeg";
const tindog = "/Yomna-s-Portfolio/assets/tindog-f81aed79.jpeg";
const projects = [
  {
    image: whosapp,
    title: "Whosapp",
    description: "Mobile app for users to get the nearst services.",
    modalDescription: "In the project I did build two apps one for the users and the other for the admin Service providers can create their services and users can search by location and contact the service provider.",
    technologies: "Flutter\n - BloC - Clean Structure - Google Maps - Firebase (Authentication - Firestore - Storage - Push Notifications)",
    isApp: true,
    onUpwork: true,
    playStoreLink: "https://play.google.com/store/apps/details?id=com.whos.whosapp",
  ...
  },
  {
    ...
    modalDescription: "The app has 2 types of users to hire or get hired where users get to see filtered user depending on their preferences and contact each other via WhatsApp, email and phone number",
    technologies: "Flutter\n - BloC - Clean Structure - Firebase (Authentication - Firestore - Storage)",
    isApp: true,
    onUpwork: true,
    playStoreLink: "https://play.google.com/store/apps/details?id=com.mickaelrobin.nannyfinderuae",
  ...
  },
  {
    ...
    modalDescription: "I did changes to this project migration the app to null safety improving the ui and the architecture setup.",
    technologies: "Flutter\n - BloC - Clean Structure - Firebase (Deep linking - Firebase analytics)",
    isApp: true,
    onUpwork: true,
    playStoreLink: "https://play.google.com/store/apps/details?id=com.ghfootballapp.app&hl=en&gl=US",
    appStoreLink: "https://apps.apple.com/eg/app/ghana-football-app/id1586234457"
  },
  {
    image: todo,
    title: "To-do React App",
    description: "React web app to add to-dos.",
    modalDescription: "To-do is a React Js app where user can save their to-dos offline in the browser.",
  ...
  },
  {
    ...
    modalDescription: "Front-end Development is a landing page built using bootstrap.",
  ...
  return /* @__PURE__ */ jsx(GridItem, { children: /* @__PURE__ */ jsx(
    Card,
    {
      ...
      children: /* @__PURE__ */ jsxs(VStack, { children: [
        /* @__PURE__ */ jsx(Center, { children: project.image && /* @__PURE__ */ jsx(
          Image$1,
          {
            src: project.image,
            height: "150px",
        ...
        project.title && /* @__PURE__ */ jsx(Text, { as: "b", px: "4", fontSize: "md", children: project.title }),
        /* @__PURE__ */ jsxs(
          Modal,
          {
            ...
            isCentered: true,
            children: [
              /* @__PURE__ */ jsx(ModalOverlay, { backgroundColor: "transparent" }),
              /* @__PURE__ */ jsxs(ModalContent, { px: "8", py: "4", children: [
                /* @__PURE__ */ jsx(Text, { as: "b", children: project.title }),
                /* @__PURE__ */ jsx(ModalCloseButton, {}),
                /* @__PURE__ */ jsxs(ModalBody, { children: [
                  /* @__PURE__ */ jsx(Text, { fontWeight: "bold", mb: "1rem", children: "Summary:" }),
                  /* @__PURE__ */ jsx(Text, { fontWeight: "bold", mb: "1rem", children: project.modalDescription }),
                  /* @__PURE__ */ jsx(Text, { fontWeight: "bold", mb: "1rem", children: "Technologies:" }),
                  /* @__PURE__ */ jsx(Text, { fontWeight: "bold", mb: "1rem", children: project.technologies }),
                  /* @__PURE__ */ jsxs(HStack, { gap: "4", children: [
                    project.onUpwork && /* @__PURE__ */ jsx(
                      Link,
                      {
                    ...
                    project.isApp ? /* @__PURE__ */ jsxs(HStack, { gap: "4", children: [
                      /* @__PURE__ */ jsx(
                        Link,
                        {
                          ...
                          children: /* @__PURE__ */ jsx(FaGooglePlay, { size: "20", cursor: "pointer" })
                        }
                      ),
                      /* @__PURE__ */ jsx(
                        Link,
                        {
                          ...
                          children: /* @__PURE__ */ jsx(FaApple, { size: "20", cursor: "pointer" })
                        }
                      )
                    ] }) : /* @__PURE__ */ jsxs(HStack, { gap: "4", children: [
                      /* @__PURE__ */ jsx(
                        Link,
                        {
                          ...
                          children: /* @__PURE__ */ jsx(FaCode, { size: "20", cursor: "pointer" })
                        }
                      ),
                      /* @__PURE__ */ jsx(
                        Link,
                        {
                          ...
                          children: /* @__PURE__ */ jsx(FaGithub, { size: "20", cursor: "pointer" })
                        }
                      )
                    ] })
                  ] })
...
function Projects() {
  return /* @__PURE__ */ jsx(Box, { px: mainPx, id: "projects", children: /* @__PURE__ */ jsxs(MotionItem, { children: [
    /* @__PURE__ */ jsx(Center, { mb: "8", children: /* @__PURE__ */ jsx(Heading, { children: "My Recent Projects" }) }),
    /* @__PURE__ */ jsx(
      Grid,
      {
        templateColumns: {
...
const SkillBar = ({ title, percentage }) => /* @__PURE__ */ jsxs(GridItem, { mx: "4", children: [
  /* @__PURE__ */ jsx(Text, { mb: "2", fontSize: "sm", children: title }),
  /* @__PURE__ */ jsx(
    Progress,
    {
      value: percentage,
...
const StackSkill = ({ title, percentage, icon }) => /* @__PURE__ */ jsx(GridItem, { children: /* @__PURE__ */ jsxs(VStack, { children: [
  ...
  /* @__PURE__ */ jsxs(HStack, { children: [
    icon,
    /* @__PURE__ */ jsx(Text, { fontSize: "sm", children: title })
  ] })
] }) });
function Skills() {
  const stacks = [
  ...
  return /* @__PURE__ */ jsx(Box, { px: mainPx, id: "skills", children: /* @__PURE__ */ jsxs(MotionItem, { children: [
    /* @__PURE__ */ jsx(Center, { my: "8", children: /* @__PURE__ */ jsx(Heading, { children: "My Skills" }) }),
    ...
    /* @__PURE__ */ jsx(Center, { my: "8", children: /* @__PURE__ */ jsx(Heading, { children: "Stacks" }) }),
...
function HireMe() {
  ...
  return /* @__PURE__ */ jsx(Box, { px: mainPx, py: "20", id: "hire me", children: /* @__PURE__ */ jsx(MotionItem, { children: /* @__PURE__ */ jsxs(VStack, { children: [
    /* @__PURE__ */ jsx(Center, { children: /* @__PURE__ */ jsx(Heading, { children: "Hire Me" }) }),
    /* @__PURE__ */ jsxs(
      VStack,
      {
        width: {
        ...
        children: [
          /* @__PURE__ */ jsxs(FormControl, { isRequired: true, children: [
            /* @__PURE__ */ jsx(FormLabel, { htmlFor: "email", children: "Email address" }),
            /* @__PURE__ */ jsx(
              Input,
              {
                id: "email",
          ...
          /* @__PURE__ */ jsxs(FormControl, { isRequired: true, children: [
            ...
            /* @__PURE__ */ jsxs(
              Select,
              {
                ...
                value: subject,
                onChange: (e2) => {
                  setSubject(e2.target.value);
                },
                children: [
                  /* @__PURE__ */ jsx("option", { children: "Freelance Project" }),
                  /* @__PURE__ */ jsx("option", { children: "Full/Part Time Job" }),
          ...
          /* @__PURE__ */ jsx(
            Button,
            {
              ...
              children: email && subject && message && validateEmail(email) ? /* @__PURE__ */ jsx(
                Link,
                {
              ...
              ) : /* @__PURE__ */ jsx(Text, { children: "Send" })
            }
          )
        ]
      }
...
function Footer() {
  return /* @__PURE__ */ jsx(Box, { py: "8", backgroundColor: "pinkish", color: "white", children: /* @__PURE__ */ jsxs(Flex, { justifyContent: "space-evenly", children: [
    /* @__PURE__ */ jsx(Text, { children: "© 2023 Copy right Yomna Salah" }),
    /* @__PURE__ */ jsx(Text, { children: "Made with ❤ " })
  ] }) });
}
function Layout() {
  const myGradient = [`linear(to-tl, #f7ebf5, white)`];
  return /* @__PURE__ */ jsxs(Box, { w: "100%", h: "100%", bgGradient: myGradient, children: [
    /* @__PURE__ */ jsx(NavBar, {}),
